...
def getAdInformation(directory):
    ...
    title, price, description = (
        open("ad/" + directory + "/Ad.txt").read().split("\n", 2)
    )
...
def login(creds):
    ...
    # email
    browser.find_element_by_name("email").send_keys(creds[0])
    # pass
    browser.find_element_by_name("pass").send_keys(creds[1])
    # click login
...
def postAd(browser, directory):
    ...
    browser.find_element_by_xpath(
        "/html/body/div[1]/div[3]/div[1]/div/div/div[1]/div/div/div/button"
    ).click()
    time.sleep(longSleep)
    ...
    browser.find_element_by_xpath(
        "/html/body/div[6]/div"
        "[2]/div/div/div/div/div[2]/div/div/div[1]/div[1]/div/span/span/label/input"
    ).click()
    time.sleep(shortSleep)
    ...
    # Allow page to load
    browser.find_element_by_xpath(
        "/html/body/div[6]/div[2]/div/div/div/div/div[2]/div/div/div[3]/div/div[2]/div/div/span/button/span"
    ).click()
    time.sleep(longSleep)
...
def main():
    ...
    for creds in credentials:
        ...
        # Allow page to load
        browser.find_element_by_xpath(
            "/html/body/div[1]/div/div[1]/div[1]/div[3]/div/div/div[1]/div[1]/div/div[1]/div/div/div[1]/div/div/div[1]/div[1]/ul/li[5]/div/a"
        ).click()
        time.sleep(5)
        ...
        mount = "mount_0_0"
        browser.find_element_by_xpath(
            f"//*[@id={mount}]/div/div[1]/div[1]/div[3]/div/div/div[1]/div[1]/div[1]/div/div[3]/div[1]/div[2]/div/div/div[4]/div/span/a"
        ).click()
